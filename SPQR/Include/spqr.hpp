...
// METIS normally uses the SuiteSparse_config function pointers for
// malloc/calloc/realloc/free, so it can use the same memory manager functions
// as the rest of SuiteSparse.  During test coverage, METIS is allowed to use
// the standard ANSI C11 allocation functions instead.
