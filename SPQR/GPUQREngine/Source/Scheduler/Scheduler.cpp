...
template bool Scheduler<int32_t>::initialize(size_t);
template bool Scheduler<int64_t>::initialize(size_t);

template void Scheduler<int32_t>::toggleQueue();
template void Scheduler<int64_t>::toggleQueue();
