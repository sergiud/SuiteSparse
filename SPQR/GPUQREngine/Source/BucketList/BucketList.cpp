...
template double *BucketList<int32_t>::allocateVT();
template double *BucketList<int64_t>::allocateVT();

template bool BucketList<int32_t>::IsDone();
template bool BucketList<int64_t>::IsDone();
