...
#ifdef GPUQRENGINE_PIPELINING
template void LLBundle<int32_t>::AddTileToDelta(int32_t);
template void LLBundle<int64_t>::AddTileToDelta(int64_t);
#endif
...
template void LLBundle<int32_t>::AddTileToSlots(int32_t);
template void LLBundle<int64_t>::AddTileToSlots(int64_t);
