...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT Int SuiteSparseQR
(
    // inputs, not modified
...
// X = A\dense(B)
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_dense *SuiteSparseQR
(
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,
    cholmod_sparse *A,      // m-by-n sparse matrix
...
// X = A\sparse(B)
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_sparse *SuiteSparseQR
(
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,
    cholmod_sparse *A,      // m-by-n sparse matrix
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_dense *SuiteSparseQR_qmult
(
    // inputs, no modified
    int method,         // 0,1,2,3
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_sparse *SuiteSparseQR_qmult
(
    // inputs, no modified
    int method,             // 0,1,2,3
    cholmod_sparse *H,      // either m-by-nh or n-by-nh
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_dense *SuiteSparseQR_solve    // returns X
(
    // inputs, not modified:
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_sparse *SuiteSparseQR_solve    // returns X
(
    // inputs, not modified:
...
// free the QR object
template <typename Entry, typename Int = int64_t> SPQR_EXPORT int SuiteSparseQR_free
(
    SuiteSparseQR_factorization <Entry, Int> **QR, // of an m-by-n sparse matrix A
    cholmod_common *cc
) ;
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_dense *SuiteSparseQR_min2norm
(
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,
    cholmod_sparse *A,
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT cholmod_sparse *SuiteSparseQR_min2norm
(
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,
    cholmod_sparse *A,
...
template <typename Entry, typename Int = int64_t> SPQR_EXPORT int SuiteSparseQR_numeric
(
    // inputs:
    double tol,             // treat columns with 2-norm <= tol as zero
    cholmod_sparse *A,      // sparse matrix to factorize
...
extern template SPQR_EXPORT int SuiteSparseQR_numeric <double, int32_t>
(
    // inputs:
    double tol,             // treat columns with 2-norm <= tol as zero
    cholmod_sparse *A,      // sparse matrix to factorize
...
extern template SPQR_EXPORT int SuiteSparseQR_numeric <Complex, int32_t>
(
    // inputs:
    double tol,             // treat columns with 2-norm <= tol as zero
    cholmod_sparse *A,      // sparse matrix to factorize
...
extern template SPQR_EXPORT int SuiteSparseQR_numeric <double, int64_t>
(
    // inputs:
    double tol,             // treat columns with 2-norm <= tol as zero
    cholmod_sparse *A,      // sparse matrix to factorize
...
extern template SPQR_EXPORT int SuiteSparseQR_numeric <Complex, int64_t>
(
    // inputs:
    double tol,             // treat columns with 2-norm <= tol as zero
    cholmod_sparse *A,      // sparse matrix to factorize
