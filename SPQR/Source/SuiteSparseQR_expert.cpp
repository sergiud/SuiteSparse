...
template SPQR_EXPORT SuiteSparseQR_factorization <double, int32_t> *SuiteSparseQR_factorize <double, int32_t>
(
    // inputs, not modified:
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,             // treat columns with 2-norm <= tol as zero
...
template SPQR_EXPORT SuiteSparseQR_factorization <Complex, int32_t> *SuiteSparseQR_factorize<Complex, int32_t>
(
    // inputs, not modified:
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,             // treat columns with 2-norm <= tol as zero
...
template SPQR_EXPORT SuiteSparseQR_factorization <double, int64_t> *SuiteSparseQR_factorize <double, int64_t>
(
    // inputs, not modified:
    int ordering,           // all, except 3:given treated as 0:fixed
    double tol,             // treat columns with 2-norm <= tol as zero
...
template SPQR_EXPORT cholmod_dense *SuiteSparseQR_solve <Complex, int32_t>
(
    // inputs, not modified:
...
template SPQR_EXPORT cholmod_dense *SuiteSparseQR_solve <double, int64_t>
(
    // inputs, not modified:
    int system,                 // which system to solve
...
template SPQR_EXPORT cholmod_dense *SuiteSparseQR_solve <double, int32_t>
(
    // inputs, not modified:
    int system,                 // which system to solve
...
template SPQR_EXPORT cholmod_dense *SuiteSparseQR_qmult <double, int32_t>
(
    // inputs, not modified
    int method,             // 0,1,2,3
    SuiteSparseQR_factorization <double, int32_t> *QR,
...
template SPQR_EXPORT cholmod_dense *SuiteSparseQR_qmult <double, int64_t>
(
    // inputs, not modified
    int method,             // 0,1,2,3
    SuiteSparseQR_factorization <double, int64_t> *QR,
...
template SPQR_EXPORT cholmod_dense *SuiteSparseQR_qmult <Complex, int32_t>
(
    // inputs, not modified
    int method,             // 0,1,2,3
    SuiteSparseQR_factorization <Complex, int32_t> *QR,
...
template SPQR_EXPORT int SuiteSparseQR_free <double, int32_t>
(
    SuiteSparseQR_factorization <double, int32_t> **QR,
    cholmod_common *cc
) ;
template SPQR_EXPORT int SuiteSparseQR_free <double, int64_t>
(
    SuiteSparseQR_factorization <double, int64_t> **QR,
    cholmod_common *cc
) ;

template SPQR_EXPORT int SuiteSparseQR_free <Complex, int32_t>
(
    SuiteSparseQR_factorization <Complex, int32_t> **QR,
    cholmod_common *cc
) ;
