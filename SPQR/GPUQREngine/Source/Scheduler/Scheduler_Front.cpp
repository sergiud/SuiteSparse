...
template void Scheduler<int32_t>::activateFront(int32_t);
template void Scheduler<int64_t>::activateFront(int64_t);
template bool Scheduler<int32_t>::pullFrontData(int32_t);
template bool Scheduler<int64_t>::pullFrontData(int64_t);
template bool Scheduler<int32_t>::finishFront(int32_t);
template bool Scheduler<int64_t>::finishFront(int64_t);
template void Scheduler<int32_t>::debugDumpFront(Front<int32_t> *);
template void Scheduler<int64_t>::debugDumpFront(Front<int64_t> *);
