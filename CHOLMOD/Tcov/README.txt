...
This legacy coverage harness is retained as upstream reference material. It is
not a supported build entry point for this fork because the generated source
variants it used have been removed. Configure the top-level CMake project with
BUILD_TESTING=ON and run CTest for the supported SuiteSparse tests. Type
./go to test the GPU when the required legacy coverage environment is
available.
