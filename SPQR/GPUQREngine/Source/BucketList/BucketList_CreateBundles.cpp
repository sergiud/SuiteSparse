...
template bool BucketList<int32_t>::SkipBundleCreation(int32_t, int32_t);
template bool BucketList<int64_t>::SkipBundleCreation(int64_t, int64_t);
template bool BucketList<int32_t>::IsInternal(LLBundle<int32_t>&, int);
template bool BucketList<int64_t>::IsInternal(LLBundle<int64_t>&, int);
