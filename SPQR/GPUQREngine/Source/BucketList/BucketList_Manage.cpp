...
template void BucketList<int32_t>::Insert(int32_t, int32_t, bool);
template void BucketList<int64_t>::Insert(int64_t, int64_t, bool);
template void BucketList<int32_t>::Remove(int32_t, int32_t);
template void BucketList<int64_t>::Remove(int64_t, int64_t);

#ifdef GPUQRENGINE_PIPELINING
template int32_t BucketList<int32_t>::RemoveHead(int32_t);
template int64_t BucketList<int64_t>::RemoveHead(int64_t);
#endif
