...
% METIS is optional.  Set METIS_ROOT for a non-standard installation.
%
...
% Determine if METIS is available.  The compiler searches its system include
% paths when METIS_ROOT is not set.
